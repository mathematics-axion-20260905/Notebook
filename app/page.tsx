...
const notebookLandingCopy = {
  en: {
    ...
    productTitle: "A notebook that remembers the research, not just the text.",
    productCopy: "Build a readable trail from question to finding. Typed blocks add scientific structure when useful while the document stays calm and human-first.",
    heroKicker: "Axion Notebook · research memory",
    heroTitle: ["Reasoning,", "kept", "alive."],
    heroLead: "Capture explanations, formulas, code, figures and results without separating them from the scientific work that produced them.",
    open: "Open Notebook",
    explore: "Explore the product",
    promises: [["Think", "Write questions, explanations and observations in a document made for reading."], ["Compute", "Bring in mathematics and code when reasoning needs them, not as the whole interface."], ["Connect", "Keep evidence tied to the Project so context survives the next handoff."]],
    workflowKicker: "Research workflow",
    workflowTitle: "From a question to a finding, in one readable trail.",
    workflowCopy: "Notebook is not another solver. It is where scientific context, interpretation and evidence remain legible over time.",
    ...
    ecosystemTitle: "Reasoning should stay connected to the result.",
    ...
    finalTitle: ["Research memory should feel like an", "instrument."],
    finalCopy: "Open a quiet notebook where explanations, mathematics, code and evidence stay in the same scientific context.",
  ...
  uz: {
    ...
    productKicker: "Mahsulot",
    productTitle: "Faqat matnni emas, tadqiqotning o‘zini eslab qoladigan notebook.",
    productCopy: "Savoldan xulosagacha o‘qilishi oson iz yarating. Tiplangan bloklar kerak bo‘lganda ilmiy tuzilma qo‘shadi, hujjat esa sodda va insoniyligicha qoladi.",
    heroKicker: "Axion Notebook · tadqiqot xotirasi",
    heroTitle: ["Fikrlash,", "doim", "jonli."],
    heroLead: "Izohlar, formulalar, kod, grafiklar va natijalarni ularni yaratgan ilmiy ish bilan birga saqlang.",
    open: "Notebookni ochish",
    explore: "Mahsulotni ko‘rish",
    promises: [["Fikrla", "Savollar, izohlar va kuzatuvlarni o‘qishga qulay hujjatda yozing."], ["Hisobla", "Fikrlashga kerak bo‘lganda matematika va kodni qo‘shing, interfeysni murakkablashtirmang."], ["Bog‘la", "Keyingi bosqichda kontekst saqlanishi uchun dalillarni Loyiha bilan bog‘lang."]],
    workflowKicker: "Tadqiqot jarayoni",
    workflowTitle: "Savoldan xulosagacha — bitta o‘qilishi oson iz.",
    workflowCopy: "Notebook yana bir solver emas. U ilmiy kontekst, talqin va dalillar vaqt o‘tishi bilan ham tushunarli qoladigan joy.",
    ...
    ecosystemTitle: "Fikrlash natijadan uzilib qolmasin.",
    ...
    finalTitle: ["Tadqiqot xotirasi", "asbobdek"],
    finalCopy: "Izohlar, matematika, kod va dalillar bir ilmiy kontekstda qoladigan sokin notebookni oching.",
